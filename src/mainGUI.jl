...
function SimBioReactorGUI()
    ...
    signal_connect(parEst, :clicked) do widget
        ...
        set_gtk_property!(parEstWin,
            :title, "Parameter Estimation - SimBioReactor 1.0")
        ...
        signal_connect(parEstLoad, "clicked") do widget
            ...
            signal_connect(parEstAdd2Data, :clicked) do widget
                ...
                global c1 = TreeViewColumn(String(labelX),
                    rTxt1, Dict([("text", 0)]))
                global c2 = TreeViewColumn(String(labelY),
                    rTxt1, Dict([("text", 1)]))
        ...
        choices = ["Bertalanffy", "Brody", "Gompertz", "Logistic", "Best model"]
